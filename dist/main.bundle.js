...
/******/ 	var hotCurrentHash = "25e49c6a5caefa7c54b7"; // eslint-disable-line no-unused-vars
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.FilmController = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _router = __webpack_require__(/*! ../../utils/router.js */ \"./app/utils/router.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar FilmController = exports.FilmController = function () {\n  function FilmController() {\n    _classCallCheck(this, FilmController);\n\n    this.router = new _router.Router();\n  }\n\n  _createClass(FilmController, [{\n    key: 'backToPreviousRoute',\n    value: function backToPreviousRoute() {\n      this.router.navigateBackRoute();\n    }\n  }]);\n\n  return FilmController;\n}();\n\n//# sourceURL=webpack:///./app/components/Film/film.controller.js?");

/***/ }),

/***/ "./app/components/Film/film.view.js":
/*!******************************************!*\
  !*** ./app/components/Film/film.view.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.FilmView = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _filmController = __webpack_require__(/*! ./film.controller.js */ \"./app/components/Film/film.controller.js\");\n\nvar _eventAttachHelperService = __webpack_require__(/*! ../../utils/eventAttachHelper.service.js */ \"./app/utils/eventAttachHelper.service.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar FilmView = exports.FilmView = function () {\n  function FilmView() {\n    _classCallCheck(this, FilmView);\n\n    this.filmController = new _filmController.FilmController();\n    this.eventHelper = new _eventAttachHelperService.EventHelper();\n  }\n\n  _createClass(FilmView, [{\n    key: 'init',\n    value: function init() {\n      this.container = document.getElementById('container');\n    }\n  }, {\n    key: 'render',\n    value: function render(data) {\n      this.container.innerHTML = '';\n      this.buildPanel(data);\n    }\n  }, {\n    key: 'buildPanel',\n    value: function buildPanel(film) {\n      var container = document.getElementById('container'),\n          searchContainer = document.getElementById('search-container'),\n          div = document.createElement('div');\n\n      searchContainer.innerHTML = '';\n      container.innerHTML = '';\n      div.innerHTML = '';\n\n      if (film) {\n        var strHmtl = '\\n        <div class=\"panel-group\">\\n          <div class=\"panel panel-primary\" style=\"display: inline-block; width:350px; margin: 20px;\">\\n            <div class=\"panel-body\" style=\"margin: 10px;\">\\n              <div> ' + film.Title + '</div>\\n              <div> ' + film.Year + '</div>\\n              <div> ' + film.Type + '</div>\\n              <img class=\"poster-image\" src=' + film.Poster + '/>\\n            </div>\\n          </div>\\n        </div>\\n        <button class=\"btn btn-primary\" id=\"back-button\">Back</button>';\n\n        div.innerHTML = strHmtl;\n        container.appendChild(div);\n\n        var backButton = document.getElementById('back-button');\n\n        this.eventHelper.attachEvent(backButton, 'click', this.backToPreviousRouteHandler.bind(this));\n      }\n    }\n  }, {\n    key: 'backToPreviousRouteHandler',\n    value: function backToPreviousRouteHandler() {\n      this.filmController.backToPreviousRoute();\n    }\n  }]);\n\n  return FilmView;\n}();\n\n//# sourceURL=webpack:///./app/components/Film/film.view.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.Model = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _fetchServiceService = __webpack_require__(/*! ../utils/fetchService.service.js */ \"./app/utils/fetchService.service.js\");\n\nvar _eventEmitterService = __webpack_require__(/*! ../utils/eventEmitter.service.js */ \"./app/utils/eventEmitter.service.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar instance = null;\n\nvar Model = exports.Model = function () {\n  function Model() {\n    _classCallCheck(this, Model);\n\n    if (!instance) {\n      this.fetchService = new _fetchServiceService.FetchService();\n      this.eventEmitter = new _eventEmitterService.EventEmitter();\n      this.films = [];\n\n      instance = this;\n    }\n    return instance;\n  }\n\n  _createClass(Model, [{\n    key: 'search',\n    value: function search(arg) {\n      var _this = this;\n\n      this.fetchService.getFilmsBySearchValue(arg).then(function (response) {\n        return response.json();\n      }).then(function (searchData) {\n        _this.films = searchData.Search;\n        _this.eventEmitter.triggerEvent('filmsView', 'render', _this.films);\n      });\n    }\n  }]);\n\n  return Model;\n}();\n\n//# sourceURL=webpack:///./app/model/model.js?");

/***/ }),

/***/ "./app/utils/eventAttachHelper.service.js":
/*!************************************************!*\
  !*** ./app/utils/eventAttachHelper.service.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar EventHelper = exports.EventHelper = function () {\n  function EventHelper() {\n    _classCallCheck(this, EventHelper);\n  }\n\n  _createClass(EventHelper, [{\n    key: \"attachEvent\",\n    value: function attachEvent(objects, eventType, handler) {\n      if (objects.length) objects.forEach(function (item) {\n        item.addEventListener(eventType, handler);\n      });else objects.addEventListener(eventType, handler);\n    }\n  }]);\n\n  return EventHelper;\n}();\n\n//# sourceURL=webpack:///./app/utils/eventAttachHelper.service.js?");

/***/ }),

/***/ "./app/utils/eventEmitter.service.js":
/*!*******************************************!*\
  !*** ./app/utils/eventEmitter.service.js ***!
  \*******************************************/
/*! no static exports found */
